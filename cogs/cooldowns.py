    ...
    async def on_message(self, message: discord.Message) -> None:
        ...
        if user_settings.alert_daily.enabled:
            ...
            if daily_search is not None:
                ...
                daily_message = user_settings.alert_daily.message.replace('%','rpg daily')
        ...
        if user_settings.alert_weekly.enabled:
            ...
            if weekly_search is not None:
                ...
                weekly_message = user_settings.alert_weekly.message.replace('%','rpg weekly')
        ...
        if user_settings.alert_lootbox.enabled:
            ...
            if lb_search is not None:
                ...
                lb_message = user_settings.alert_lootbox.message.replace('%','rpg buy lootbox')
        ...
        if user_settings.alert_adventure.enabled:
            ...
            if adv_search is not None:
                ...
                adv_message = user_settings.alert_adventure.message.replace('%',adv_command)
        ...
        if user_settings.alert_training.enabled:
            ...
            if tr_search is not None:
                ...
                tr_message = user_settings.alert_training.message.replace('%',tr_command)
        ...
        if user_settings.alert_quest.enabled:
            ...
            if quest_search is not None:
                ...
                quest_message = user_settings.alert_quest.message.replace('%','rpg quest')
        ...
        if user_settings.alert_duel.enabled:
            ...
            if duel_search is not None:
                ...
                duel_message = user_settings.alert_duel.message.replace('%','rpg duel')
        ...
        if user_settings.alert_arena.enabled:
            ...
            if arena_search is not None:
                ...
                arena_message = user_settings.alert_arena.message.replace('%','rpg arena')
        ...
        if user_settings.alert_dungeon_miniboss.enabled:
            ...
            if dungmb_search is not None:
                ...
                dungmb_message = user_settings.alert_dungeon_miniboss.message.replace('%','rpg dungeon / miniboss')
        ...
        if user_settings.alert_horse_breed.enabled:
            ...
            if horse_search is not None:
                ...
                horse_message = user_settings.alert_horse_breed.message.replace('%','rpg horse breed / race')
        ...
        if user_settings.alert_vote.enabled:
            ...
            if vote_search is not None:
                ...
                vote_message = user_settings.alert_vote.message.replace('%','rpg vote')
        ...
        if user_settings.alert_farm.enabled:
            ...
            if farm_search is not None:
                ...
                farm_message = user_settings.alert_farm.message.replace('%','rpg farm')
        ...
        if user_settings.alert_work.enabled:
            ...
            if work_search is not None:
                ...
                work_message = user_settings.alert_work.message.replace('%','work command')
