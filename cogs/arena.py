...
class ArenaCog(commands.Cog):
    ...
    async def arena(self, ctx: commands.Context, *args: tuple) -> None:
        ...
        try:
            try:
                ...
                return
            if not user.reminders_enabled or not user.alert_arena.enabled: return
            ...
            if bot_message.find(f'{ctx_author}\'s cooldown') > -1:
                ...
                reminder: reminders.Reminder = reminders.insert_user_reminder(ctx.author.id, 'arena', time_left,
