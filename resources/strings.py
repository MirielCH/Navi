...
ACTIVITIES_COLUMNS: Final[dict[str, str]] = {
    ...
    'boo': 'alert_boo',
    'boosts': 'alert_boosts',
    'boring-beach-party': 'alert_boosts',
    ...
    'normal-beach-party': 'alert_boosts',
...
MONSTERS_ADVENTURE_GALAXY: Final[tuple[str, ...]] = (
    '**Two Aliens**',
    '**Three Aliens**',
    '**Four Aliens**',
)
...
MONSTERS_ADVENTURE: Final[tuple[str, ...]] = (
    ...
    + MONSTERS_ADVENTURE_MISC + MONSTERS_ADVENTURE_GALAXY
)
...
MONSTERS_HUNT_GALAXY: Final[tuple[str, ...]] = (
    '**Biter**',
    '**Spitter**',
    '**Alien**',
)
...
MONSTERS_HUNT: Final[tuple[str, ...]] = (
    ...
    + MONSTERS_HUNT_MISC + MONSTERS_HUNT_GALAXY
)
...
MONSTERS_AREA: Final[dict[int, tuple[str, ...]]] = {
    ...
    21: MONSTERS_HUNT_TOP + MONSTERS_ADVENTURE_GALAXY,
}
